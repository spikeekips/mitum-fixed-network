...
func (t *testSession) SetupSuite() {
	...
	_ = encs.TestAddHinter(ballot.ACCEPTFactHinter)
	_ = encs.TestAddHinter(ballot.ACCEPTHinter)
	_ = encs.TestAddHinter(ballot.INITFactHinter)
	_ = encs.TestAddHinter(ballot.INITHinter)
	_ = encs.TestAddHinter(ballot.ProposalFactHinter)
	_ = encs.TestAddHinter(ballot.ProposalHinter)
	_ = encs.TestAddHinter(base.BallotFactSignHinter)
	_ = encs.TestAddHinter(base.BaseFactSignHinter)
	_ = encs.TestAddHinter(base.SignedBallotFactHinter)
	_ = encs.TestAddHinter(base.StringAddressHinter)
	_ = encs.TestAddHinter(base.VoteproofV0Hinter)
	_ = encs.TestAddHinter(block.BlockV0Hinter)
	_ = encs.TestAddHinter(block.BlockConsensusInfoV0Hinter)
	_ = encs.TestAddHinter(block.ManifestV0Hinter)
	_ = encs.TestAddHinter(block.SuffrageInfoV0Hinter)
	_ = encs.TestAddHinter(key.BasePrivatekey{})
	_ = encs.TestAddHinter(key.BasePublickey{})
	_ = encs.TestAddHinter(node.BaseV0Hinter)
	...
	_ = encs.TestAddHinter(state.BytesValueHinter)
	_ = encs.TestAddHinter(state.DurationValueHinter)
	_ = encs.TestAddHinter(state.HintedValueHinter)
	_ = encs.TestAddHinter(state.NumberValueHinter)
	_ = encs.TestAddHinter(state.SliceValueHinter)
	_ = encs.TestAddHinter(state.StateV0{})
	_ = encs.TestAddHinter(state.StringValueHinter)
	_ = encs.TestAddHinter(tree.FixedTreeHinter)
