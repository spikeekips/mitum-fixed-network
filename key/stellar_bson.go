...
func (sp StellarPrivatekey) EncodeBSON(enc *encoder.HintEncoder) (interface{}, error) {
	return &struct {
		K string `bson:"key"`
	}{
		K: sp.String(),
...
func (sp StellarPublickey) EncodeBSON(enc *encoder.HintEncoder) (interface{}, error) {
	return &struct {
		K string `bson:"key"`
	}{
		K: sp.String(),
