...
func (t *testStellarKeypair) TestPrivatekeyBSONMarshal() {
	...
	b, err := be.Encode(kp)
	t.NoError(err)
	t.Equal("74000000035f68696e74001a0000000574000200000000020002760004000000302e310000035f646174610047000000026b657900390000005343443647514d57474451543333514f434e4b594b524a5a4c33595746534c425651534c3649435657425559515a43424659555159363733000000", hex.EncodeToString(b))
...
func (t *testStellarKeypair) TestPublickeyBSONMarshal() {
	...
	b, err := be.Encode(pb)
	t.NoError(err)
	t.Equal("74000000035f68696e74001a0000000574000200000000020102760004000000302e310000035f646174610047000000026b65790039000000474156414f4e42455454344d5650563249594e3254374f42375a545958474e4e344246475a485559425559523647344143485a4d444f5136000000", hex.EncodeToString(b))
